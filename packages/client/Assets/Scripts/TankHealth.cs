...
public class TankHealth : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		var healthUpdated = ObservableExtensions.Subscribe(HealthTable.OnRecordUpdate().ObserveOnMainThread(), OnHealthChange);
		var healthDeleted = ObservableExtensions.Subscribe(HealthTable.OnRecordDelete().ObserveOnMainThread(), OnPlayerDeath);
		_disposable.Add(healthUpdated);
		_disposable.Add(healthDeleted);
	}
